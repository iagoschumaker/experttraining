...
const SECUNDARIO: Record<Pillar, Record<Pillar, ExercisePrescription[]>> = {
    ...
    LOWER: {
        ...
        PUSH: [
            ...
            { name: 'Press KB Unilateral', sets: 3, reps: '10 cada', rest: '40-60s', role: 'SECUNDARIO', level: 'BEGINNER' },
        ...
        PULL: [
            ...
            { name: 'Pull Elástico', sets: 3, reps: '12-15', rest: '40-60s', role: 'SECUNDARIO', level: 'BEGINNER' },
            { name: 'Remada Alta KB', sets: 3, reps: '10-12', rest: '40-60s', role: 'SECUNDARIO', level: 'BEGINNER' },
    ...
    PUSH: {
        LOWER: [
            ...
            { name: 'Elevação Pélvica', sets: 3, reps: '12-15', rest: '40-60s', role: 'SECUNDARIO', level: 'BEGINNER' },
            { name: 'Afundo Alternado', sets: 3, reps: '10 cada', rest: '40-60s', role: 'SECUNDARIO', level: 'BEGINNER', contraindications: ['KNEE'] },
